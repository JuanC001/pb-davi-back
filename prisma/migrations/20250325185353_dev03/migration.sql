/*
  ...
  - The values [PENDIENTE] on the enum `EventStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EventStatus_new" AS ENUM ('PROGRAMADO', 'CURSO', 'FINALIZADO', 'CANCELADO');
...
ALTER TABLE "Event" ALTER COLUMN "status" SET DEFAULT 'PROGRAMADO';
COMMIT;
